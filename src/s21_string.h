 ...
 *
 * @return A pointer to the found character, if the required character is found
in the specified section of the array. NULL - if the required character is not
found
*/
...
/// @return This function returns a pointer to the error string describing error
/// errnum.
